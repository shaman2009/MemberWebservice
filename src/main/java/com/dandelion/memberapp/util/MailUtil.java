...
public class MailUtil {
	 ...
	 */
	public static boolean sendEmail(User userInfo, String toMail, String key) throws UnsupportedEncodingException {
		...
		Session session = Session.getInstance(getSessionProperties(),new Authenticator() {
					public PasswordAuthentication getPasswordAuthentication() {
						log.debug("email sender autentication username and password");
	...
	public static boolean sendMailViaSpring(User userInfo, String toMail, String key) throws Exception{
		String receiveUser = userInfo.getAlias();
		if (receiveUser == null) {
	...
	public static Properties getSessionProperties() {
		...
		pro.setProperty(MAILSOCKETFACTORY, (String)getProperties().get(MAILSOCKETFACTORY)); 
		pro.setProperty(MAILFALLBACK, (String)getProperties().get(MAILFALLBACK)); 
