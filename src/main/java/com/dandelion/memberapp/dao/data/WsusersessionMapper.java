...
public interface WsusersessionMapper {
     ...
     * @mbggenerated Sun Oct 27 22:52:00 CST 2013
     */
    int updateByExampleSelective(@Param("record") Wsusersession record, @Param("example") WsusersessionExample example);
     ...
     * @mbggenerated Sun Oct 27 22:52:00 CST 2013
     */
    int updateByExample(@Param("record") Wsusersession record, @Param("example") WsusersessionExample example);
